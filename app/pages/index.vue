...
import {converter,differenceEuclidean,formatHex,nearest} from "culori"; const imageUrl=ref(""); const proxyUrl=ref(""); const palette=ref([]);
...
onMounted(()=>{alert(9);
  ...
  fetchU(pr.value); //uUrl.value //uUrl.value="designcandy.com";
