...
onMounted(()=>{
  //setTimeout(function(){
    const sc1=document.createElement('script'); sc1.src='https://pinfluents.com/_BCK/4/zd21/inc/zo/gl.js';
    const sc2=document.createElement('script'); sc2.src='https://pinfluents.com/_BCK/4/zd21/inc/zo/sl2.js';
