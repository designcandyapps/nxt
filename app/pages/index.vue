...
onMounted(()=>{
  setTimeout(function(){
    ...
    sc1.src='https://pinfluents.com/_BCK/4/inc/zo/gl.js';
    document.head.appendChild(sc1);

    const sc2=document.createElement('script');
    sc2.src='https://pinfluents.com/_BCK/4/inc/zo/sl2.js';
...
<template>
  <div>
    ...
    <ULandingSection :title="page.sections.title" :links="page.sections.links"><UPageGrid><ULandingCard v-for="(item,index) of page.sections.items" :key="index" v-bind="item" /><About /></UPageGrid></ULandingSection>
