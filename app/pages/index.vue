...
onMounted(()=>{
  //setTimeout(function(){
    ...
    fetchPh(prompt).then(photos=>{photos.forEach(photo=>{
...
<template>
  <ULandingHero v-if="page.hero" v-bind="page.hero">
    ...
    <span id="z"><ColorThief /></span><input id="prompt" v-model="prompt"><input id="pho" v-model="pho" style="border:9px solid red;"><input id="pho2" v-model="pho2">
